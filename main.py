...
Бот будет знать номер на которой ЗАРЕГЕСТРИРОВАН ваш аккаунт в телеграме
...
Но вряд ли через нее можно узнать «своих». В ней нет твоего <b>"Я"</b>.</i>
...
📁 КОЛЛЕКЦИИ RO
Изучить текущую коллекцию. Каждая вещь со своей историей места.
